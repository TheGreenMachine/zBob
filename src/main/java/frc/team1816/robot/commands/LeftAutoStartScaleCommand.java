...
public class LeftAutoStartScaleCommand extends CommandGroup {
    ...
    public void selectAuto() {
        ...
        if (target == 'L') {
            ...
            addSequential(new RotateXDegreesCommand(45,true,0.5),3);
            addSequential(new WaitCommand(0.1));
            ...
            addSequential(new RotateXDegreesCommand(114,true,0.5),3);
            addParallel(new SetCollectorSpeedCommand(1));
            addSequential(new DriveXInchesCommand(68,0.6,0.4,0.1));
            addSequential(new WaitCommand(0.5));

            addSequential(new DriveXInchesCommand(68,-0.8,0.6,0.2));
            addParallel(new RaiseElevatorCommand());
            addSequential(new RotateXDegreesCommand(-114,true,0.4));
            addSequential(new SetCollectorSpeedCommand(0));
