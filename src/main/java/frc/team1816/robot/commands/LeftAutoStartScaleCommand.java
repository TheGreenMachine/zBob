    ...
    public void selectAuto() {
        ...
        if (target == 'L') {
            if(dsString.charAt(0) == 'L') {
                ...
                addSequential(new RotateXDegreesCommand(45, true, 0.7), 3); //prev v 0.6
                addSequential(new WaitCommand(1)); //messing with
                ...
                addSequential(new RotateXDegreesCommand(103, true, 0.8), 3); //prev v 0.6
                addParallel(new SetCollectorSpeedCommand(1));
                addSequential(new DriveXInchesCommand(76, 0.8, 0.4, 0.2), 4); //prev v 0.6
                ...
                addSequential(new WaitCommand(0.8)); //messing with
                addSequential(new SetCollectorSpeedCommand(-1));
...
//                addParallel(new RaiseElevatorCommand());
                ...
                addSequential(new WaitCommand(0.1));
                addSequential(new RotateXDegreesCommand(45, true, 0.8), 3);
                addSequential(new WaitCommand(0.1));

                addSequential(new ToggleCollectorCommand(true));
                addSequential(new SetCollectorSpeedCommand(-1));
                addSequential(new WaitCommand(1));
                addSequential(new DriveXInchesCommand(13, -0.8), 5);
                addParallel(new LowerElevatorCommand());
                addSequential(new SetCollectorSpeedCommand(0));
                addSequential(new WaitCommand(0.2));
            ...
            addSequential(new DriveXInchesCommand(225,1));
